// Cloudflare Worker for Print Server
// Deploy this to handle /api/admin/test-print endpoint
...
export default {
  async fetch(request) {
    ...
    // Handle API requests
    if (url.pathname === '/api/admin/test-print' && request.method === 'POST') {
      try {
    ...
    // Handle other requests - return 404 for API paths
    ...
    // Shouldn't reach here if Pages is properly configured
